...
ActiveRecord::Schema.define(version: 20140415165040) do
  ...
  add_index "nodes_templates", ["node_id", "template_id"], name: "index_nodes_templates_on_node_id_and_template_id", using: :btree
  add_index "nodes_templates", ["template_id", "node_id"], name: "index_nodes_templates_on_template_id_and_node_id", using: :btree
  ...
  add_index "topologies", ["topology_id"], name: "index_topologies_on_topology_id", using: :btree
