PatternDeployer::Application.configure do
  ...
  config.action_mailer.default_url_options = { :host => "ec2-67-202-40-92.compute-1.amazonaws.com:3000" }
  ...
  config.uploaded_files_dir = "#{config.chef_repo_dir}/devel/uploaded_files"
