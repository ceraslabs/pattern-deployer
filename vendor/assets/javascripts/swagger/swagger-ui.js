...
(function() {
  ...
  HeaderView = (function(_super) {
    ...
    HeaderView.prototype.events = {
      ...
      'click #show-deployer-icon': 'showDeployer',
    ...
    HeaderView.prototype.showDeployer = function(e) {
      return this.trigger('update-swagger-ui', {
        discoveryUrl: "http://ec2-67-202-40-92.compute-1.amazonaws.com:3000/api-docs.json",
        apiKey: ""
      });
    };
  ...
  OperationView = (function(_super) {
    ...
    OperationView.prototype.submitOperation = function(e) {
      ...
      if (error_free) {
        ...
        isFileUpload = form.find('input[type~="file"]').length !== 0;
