...
##~ @services["monitor"] = "Install an Ganglia monitoring daemon(gmond), which will collect and share various performance metric of this server"
##~ @services["monitoring_server"] = "Install an Ganglia meta deamon(gmetad) and Ganglia web frontend, which present the collected performance metric to users"
